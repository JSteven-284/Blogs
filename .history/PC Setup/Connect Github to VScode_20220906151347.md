...
Create a new repo or open an existing repo in github, copy the link by clicking the "Code" button.  

Open VScode, click "Source Code" in the sidebar and click "Clone"